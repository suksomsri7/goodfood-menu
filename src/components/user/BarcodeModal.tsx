            ...
            <div className="absolute inset-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-72 h-48 border-2 border-white rounded-2xl relative">
                  ...
                  {isScanning && (
                    <div className="absolute inset-x-2 h-0.5 bg-emerald-400 animate-pulse" 
                         style={{ 
                           top: '50%',
                ...
                <div className="bg-emerald-50 rounded-xl p-3 text-center">
                  ...
                  <div className="flex items-center justify-center">
                    <input
                      ...
                      className="w-14 text-lg font-semibold bg-transparent text-center border-b border-dashed border-emerald-300 outline-none"
                    />
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-3">
                    <div>
                      ...
                      <input
                        ...
                        value={formData.protein}
                        onChange={(e) => setFormData({ ...formData, protein: parseFloat(e.target.value) || 0 })}
                        className="w-full px-2 py-2 bg-emerald-50 rounded-lg text-center"
                      />
                    </div>
                    <div>
                ...
                <div className="bg-emerald-50 rounded-xl p-4">
                  <p className="text-sm font-medium text-emerald-800 text-center mb-1">
                  ...
                  <div className="flex items-center justify-center gap-6">
                    <button
                      onClick={() => setQuantity(Math.max(0.5, quantity - 0.5))}
                      className="w-12 h-12 bg-white rounded-full shadow-sm flex items-center justify-center border border-emerald-200"
                    >
                      <Minus className="w-5 h-5 text-emerald-600" />
                    </button>
                    <div className="text-center">
                      <span className="text-3xl font-bold text-emerald-700">{quantity}</span>
